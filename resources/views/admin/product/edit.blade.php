...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5 mt-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Ürün Güncelle</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-500">Ürün Güncelle</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        ...
        <div class="content flex-row-fluid" id="kt_content">
            <!--begin::Form-->
            <form action="{{route('admin.product.update',$product->id)}}" class="form d-flex flex-column flex-lg-row" method="post"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3"
                                 ...
                                 style="background-image: url({{storage($product->image)}})">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option value="0" @selected(!$product->is_active)>Pasif</option>
                            </select>
                            <!--end::Select2-->
                            <!--begin::Description-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-10 fv-row">
                                                ...
                                                <input type="text" name="name" class="form-control mb-2"
                                                       required placeholder="Ürün Adı" value="{{$product->name}}"/>
                                            </div>
                                            <div class="col-md-6 mb-10 fv-row">
                                                <label class="required form-label">Kategori</label>
                                                <select class="form-select mb-2" data-control="select2"
                                                        data-hide-search="true"
                                                        data-placeholder="Kategori Seçiniz" name="category_id"
                                                        id="category">
                                                    <option></option>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="price" class="form-control mb-2" placeholder="0.00"
                                                   value="{{$product->without_discount_price}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                            ...
                                            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label onclick="closeTabs()"
                                                        class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 @if($product->discount->type == 1) active @endif"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio"
                                                                   name="discount[type]" value="1" @checked($product->discount->type == 1)/>
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label onclick="open_discount_percent_tab()"
                                                        class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 @if($product->discount->type == 2) active @endif"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio" name="discount[type]" @checked($product->discount->type == 2) value="2"/>
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label onclick="open_fixed_discount()"
                                                        class="btn btn-outline btn-outline-dashed btn-outline-default d-flex text-start p-6 @if($product->discount->type == 3) active @endif"
                                                        data-kt-button="true">
                                                        <!--begin::Radio-->
                                                        <span
                                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                            <input class="form-check-input" type="radio" name="discount[type]" @checked($product->discount->type == 3) value="3"/>
                                                        </span>
                                                        <!--end::Radio-->
                                                        <!--begin::Info-->
                                                        <span class="ms-5">
                                        ...
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="@if($product->discount->type != 2) d-none @endif mb-10 fv-row" id="discount_percent_tab">
                                            <!--begin::Label-->
                                        ...
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="@if($product->discount->type != 3) d-none @endif mb-10 fv-row" id="fixed_discount_tab">
                                            <!--begin::Label-->
                                            ...
                                            <input type="text" name="discount[fixed_discount_amount]" class="form-control mb-2"
                                                   placeholder="0.00" value="{{$product->discount->fixed_discount_amount}}"/>
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row" id="variants">
                                            @foreach($product->variants as $variant)
                                                <div class="col-md-6 mb-5 variant-box variant-box-{{$loop->index}}">
                                                    <div class="lag-variant-box lag-variant-box-{{$loop->index}}">
                                                        <div class="title">
                                                            <input type="text" class="form-control m-input" placeholder="Başlık" name="variant[{{$loop->index}}][name]" value="{{$variant->name}}">
                                                            <a href="javascript:;" onclick="lagVariantCreateAdd('.lag-variant-box.lag-variant-box-{{$loop->index}}', {{$loop->index}})" data-toggle="tooltip" title="" class="btn btn-secondary btn-sm" data-original-title="Yeni Satır Ekle">
                                                                <i class="fa fa-plus"></i>
                                                            </a>
                                                            <a href="javascript:;" onclick="removeVariant('.variant-box-{{$loop->index}}')" data-toggle="tooltip" title="" class="btn btn-danger btn-sm">
...
@section('page-scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            @foreach($product->variants as $variant)
                lagVariantCreate(".lag-variant-box.lag-variant-box-{{$loop->index}}", {{$loop->index}}, [
                @foreach($variant->options as $row)
                {
                    "name": "{{$row->name}}",
                    "price": "{{$row->price}}"
                }@if(!$loop->last),@endif
