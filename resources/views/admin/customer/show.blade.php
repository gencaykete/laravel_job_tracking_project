    ...
    <div class="toolbar d-flex flex-stack mb-0 mb-lg-n4 pt-5 mt-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Müşteri Detayı</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">Müşteri Detayı</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{storage($customer->profile)}}" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">{{$customer->full_name}}</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#kt_customer_view_details" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">Bilgiler
                            ...
                            <div id="kt_customer_view_details" class="collapse show">
                                <div class="py-5 fs-6">
                                    ...
                                    <div class="text-gray-600">{{$customer->gender == 0 ? 'Erkek' : 'Kadın'}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">Kayıt Tarihi</div>
                                    <div class="text-gray-600">{{$customer->created_at->translatedFormat('d F Y H:i')}}</div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bolder mt-5">Son Güncellenme Tarihi</div>
                                    <div class="text-gray-600">{{$customer->updated_at->translatedFormat('d F Y H:i')}}</div>
                                    <!--begin::Details item-->
                                </div>
                            </div>
                            <!--end::Details content-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                               href="#payments">Alınan Ödemeler</a>
                        </li>
                        <!--end:::Tab item-->
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="datatable">
                                        ...
                                        @forelse($projects->where('status',1) as $row)
                                            <tr>
                                                <td>{{$row->name}}</td>
                                                <td>{{formatPrice($row->calculateCustomerPrice()['total'])}}</td>
                                                <td>{{formatPrice($row->calculateCustomerPrice()['remain'])}}</td>
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="datatable">
                                        ...
                                        @forelse($projects->where('status',3) as $row)
                                            <tr>
                                                <td>{{$row->name}}</td>
                                                <td>{{formatPrice($row->calculateCustomerPrice($customer->id)['total'])}}</td>
                                                <td>{{formatPrice($row->calculateCustomerPrice($customer->id)['remain'])}}</td>
                                                <td>{{$row->start_date->translatedFormat('d F Y')}}</td>
                                                @if($row->end_date < now())
                                                    <td class="text-danger">{{$row->end_date->translatedFormat('d F Y')}}</td>
                                                @else
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="datatable">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody class="fs-6 fw-bold text-gray-600">
                                        @forelse($projectCustomerPayments as $row)
                                            <tr>
                                                <td>{{$row->project->name}}</td>
                                                <td>{{number_format($row->amount)}} TL</td>
                                                <td>
                                                    @if ($row->type == 0)
                                                        {!! html()->span("Ödeme Alındı")->class('badge badge-success') !!}
                                                    @endif
