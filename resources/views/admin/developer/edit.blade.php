<div class="modal fade" id="kt_modal_update_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{route('admin.developer.update',$developer->id)}}" method="post" id="kt_modal_update_customer_form"
            ...
            <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_update_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">#{{$developer->id}} | Yazılımcı Güncelle</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                            ...
                            <div class="row">
                                ...
                                <div class="fv-row mb-7 col-md-6">
                                    ...
                                    <select name="status" class="form-select" data-placeholder="Durum" data-control="select2" data-hide-search="true" title="Durum">
                                        <option></option>
                                        <option value="0" @selected($developer->status==0)>Pasif</option>
                                        <option value="1" @selected($developer->status==1)>Aktif</option>
                                    </select>
                                </div>
                            </div>
                            <!--end::Input group-->
