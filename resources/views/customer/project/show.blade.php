                        ...
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tr>
                                        <td class="text-muted">
                                            <div class="d-flex align-items-center text-success">Ödenen</div>
                                        </td>
                                        <td class="fw-bolder text-end">
                                            <a href="#" target="_blank"
                                               class="text-gray-600 text-hover-primary">{{number_format($project->customerPaymentList()->where('type',0)->sum('amount'))}}
                                                TL</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a href="#" target="_blank"
                                               class="text-gray-600 text-hover-primary">{{number_format($project->customerPaymentList()->where('type',1)->sum('amount'))}}
                                                TL</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a href="#" target="_blank"
                                               class="text-gray-600 text-hover-primary">{{number_format($project->customerPaymentList()->where('type',2)->sum('amount'))}}
                                                TL</a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-end">
                                            <a href="#" target="_blank"
                                               class="text-gray-600 text-hover-primary">{{number_format($project->price + $project->customerPaymentList()->where('type',1)->sum('amount') - $project->customerPaymentList()->where('type',0)->sum('amount') - $project->customerPaymentList()->where('type',2)->sum('amount'))}}
                                                TL</a>
                                        </td>
                                    </tr>
                                    <!--end::Rewards-->
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                            <!--begin::Products-->
                                            @forelse($project->customerPaymentList as $row)
                                                <tr>
