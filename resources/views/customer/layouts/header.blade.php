                ...
                <div class="header-top d-flex align-items-stretch flex-grow-1">
                    ...
                    <div class="d-flex align-items-stretch admin-header" style="margin:0 auto;padding-top:30px">
                        ...
                        <div class="d-flex align-items-center align-items-lg-stretch me-5 flex-row-fluid">
                            ...
                            <!--end::Heaeder navs toggle-->
                            <!--begin::Logo-->
                            <a href="{{route('customer.home')}}" class="d-flex align-items-center">
                            ...
                            <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                                ...
                                <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs"
                                    ...
                                    <ul class="nav flex-nowrap text-nowrap" id="headerNav">
                                        <li class="nav-item">
                                            <a class="nav-link @if(request()->routeIs('customer.home')) active @endif"
                                               data-bs-toggle="" href="{{route('customer.home')}}">Anasayfa</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link @if(request()->routeIs('customer.project.*')) active @endif"
                                               data-bs-toggle="" href="{{route('customer.project.index')}}">Proje İşlemleri</a>
                                        </li>
                            ...
                            <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <span class="text-white fs-8 fw-bolder lh-1">Müşteri</span>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Symbol-->
                                ...
                                <div
                                    ...
                                    <form action="{{route('customer.logout')}}" method="post" id="logout-form">@csrf</form>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    <div class="separator my-2"></div>
                                    <!--end::Menu separator-->
