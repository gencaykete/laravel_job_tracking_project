        ...
        <div class="content flex-row-fluid" id="kt_content">
                ...
                <div class="col-lg-6 col-xxl-4">
                    <div class="card h-100">
                        <div class="card-body p-9">
                            ...
                            <div class="d-flex">
                                <a href="{{route('customer.project.index')}}" class="btn btn-primary btn-sm me-3">Proje Listesi</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-6 g-xl-9">
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body p-9">
                            <div class="fs-2hx fw-bolder">{{number_format($totalPayment)}} TL</div>
                            <div class="fs-4 fw-bold text-gray-400 mb-7">Toplam Ödeme</div>
                            <div class="d-flex flex-wrap">
                                <div class="d-flex flex-column justify-content-center flex-row-fluid pe-11 mb-5">
                                    <div class="d-flex fs-6 fw-bold align-items-center mb-3">
                                        <div class="bullet bg-primary me-3"></div>
                                        <div class="text-gray-400">Yapılan Ödeme </div>
                                        <div class="ms-auto fw-bolder text-gray-700">{{number_format($paid)}} TL</div>
                                    </div>
                                    <div class="d-flex fs-6 fw-bold align-items-center mb-3">
                                        <div class="bullet bg-success me-3"></div>
                                        <div class="text-gray-400">Kalan Ödeme </div>
                                        <div class="ms-auto fw-bolder text-gray-700">{{number_format($totalPayment - $paid + $add - $sub)}} TL</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-9">
                            ...
                            @foreach($lastActions as $row)
                                <div class="fs-6 d-flex justify-content-between mb-4">
                                    <div class="fw-bold">
                                        {!! $row->project ? '<b class="text-primary">'.$row->project->name.'</b> Projesi' : 'Silinmiş Proje' !!} için
                                        @if($row->type == 0)
